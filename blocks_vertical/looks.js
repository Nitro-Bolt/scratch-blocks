  ...
  init: function () {
    this.jsonInit({
      ...
      switches: [
        {
          id: "looks_sayforsecs",
          createInputs: { SECS: { shadowType: "math_number", value: "2" } },
        },
        "looks_think",
        {
...
Blockly.Blocks["looks_changeeffectby"] = {
  ...
  init: function () {
    this.jsonInit({
      ...
      category: Blockly.Categories.looks,
      extensions: ["colours_looks", "shape_statement"],
      switches: [{ id: "looks_seteffectto", inputs: [["CHANGE", "VALUE"]] }],
    });
  },
};
...
Blockly.Blocks["looks_seteffectto"] = {
  ...
  init: function () {
    this.jsonInit({
      ...
      category: Blockly.Categories.looks,
      extensions: ["colours_looks", "shape_statement"],
      switches: [{ id: "looks_changeeffectby", inputs: [["VALUE", "CHANGE"]] }],
    });
  },
};
...
Blockly.Blocks["looks_switchbackdropto"] = {
  ...
  init: function () {
    this.jsonInit({
      ...
      category: Blockly.Categories.looks,
      extensions: ["colours_looks", "shape_statement"],
      switches: ["looks_switchbackdroptoandwait"],
    });
  },
};
      ...
      switches: [
        {
          ...
          inputs: [["FRONT_BACK", "FORWARD_BACKWARD"]],
          mapFieldValues: {
            FRONT_BACK: { front: "forward", back: "backward" },
          },
          createInputs: { NUM: { shadowType: "math_integer", value: "1" } },
        },
      ],
    });
  },
      ...
      switches: [
        {
          ...
          splitInputs: ["NUM"],
          inputs: [["FORWARD_BACKWARD", "FRONT_BACK"]],
          mapFieldValues: {
            FORWARD_BACKWARD: { forward: "front", backward: "back" },
          },
        },
      ],
    });
...
Blockly.Blocks["looks_backdropnumbername"] = {
  ...
  init: function () {
    this.jsonInit({
      ...
      checkboxInFlyout: true,
      extensions: ["colours_looks", "output_number"],
      switches: ["looks_costumenumbername"],
    });
  },
};
...
Blockly.Blocks["looks_costumenumbername"] = {
  ...
  init: function () {
    this.jsonInit({
      ...
      checkboxInFlyout: true,
      extensions: ["colours_looks", "output_number"],
      switches: ["looks_backdropnumbername"],
    });
  },
};
...
Blockly.Blocks["looks_switchbackdroptoandwait"] = {
  ...
  init: function () {
    this.jsonInit({
      ...
      category: Blockly.Categories.looks,
      extensions: ["colours_looks", "shape_statement"],
      switches: ["looks_switchbackdropto"],
    });
  },
};
