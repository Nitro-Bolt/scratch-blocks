...
Blockly.FieldTextDropdown.fromJson = function (element) {
  const field = new Blockly.FieldTextDropdown(
    element["text"],
    element["options"]
  );
 ...
 */
Blockly.FieldTextDropdown.prototype.getValue =
  Blockly.FieldDropdown.prototype.getValue;

/**
 * Set the language-neutral value for this dropdown menu.
 * @param {string} newValue New value to set.
 */
Blockly.FieldTextDropdown.prototype.setValue =
  Blockly.FieldDropdown.prototype.setValue;

/**
 * Sets the text in this field and also updates the value.
 * @param {?string} text New text.
 * @override
 */
Blockly.FieldTextDropdown.prototype.setText = function (text) {
  if (text === null || text === this.text_) {
    // No change if null or same.
    return;
  }
  this.value_ = text;
  Blockly.FieldTextDropdown.superClass_.setText.call(this, text);
};
