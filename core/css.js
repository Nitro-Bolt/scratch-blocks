...
Blockly.Css.inject = function (hasCss, pathToMedia) {
  ...
  const compareByLength = (a, b) => b.length - a.length;
  const colourProperties = Object.keys(Blockly.Colours).sort(compareByLength);
  for (const colourProperty of colourProperties) {
    // Replace all
    text = text.replace(
...
Blockly.Css.CONTENT = [
  ...
  */
  ...
  ".scratchGroup.blocklyDragging .scratchGroupHeader {",
  'cursor: url("<<<PATH>>>/handclosed.cur"), auto;',
  "cursor: grabbing;",
  "cursor: -webkit-grabbing;",
  "cursor: -moz-grabbing;",
  ...
  ".blocklyFieldSlider:focus {",
  "outline: none;",
  "}",

  ".blocklyFieldSlider::-webkit-slider-runnable-track {",
  "background: var(--blockly-slider-track-colour, #ddd);",
  "border-radius: 5px;",
  "height: 10px;",
  "}",

  ".blocklyFieldSlider::-webkit-slider-thumb {",
  "-webkit-appearance: none;",
  "appearance: none;",
  "background: #fff;",
  "border: none;",
  ...
  ".blocklyFieldSlider::-moz-range-track {",
  "background: var(--blockly-slider-track-colour, #ddd);",
  "border-radius: 5px;",
  "height: 10px;",
  "}",

  ".blocklyFieldSlider::-moz-range-thumb {",
  "background: #fff;",
  "border: none;",
  "border-radius: 50%;",
  "box-shadow: 0 0 0 4px rgba(255, 255, 255, 0.15);",
  ...
  ".blocklyFieldSlider::-moz-focus-outer {",
  "border: 0;",
  "}",
