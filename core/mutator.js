...
Blockly.Mutator.prototype.createEditor_ = function () {
  ...
  */
  ...
  if (this.quarkNames_.length) {
    ...
    for (i = 0; (quarkName = this.quarkNames_[i]); i++) {
...
Blockly.Mutator.prototype.setVisible = function (visible) {
  ...
  if (visible) {
    ...
    if (this.workspace_.flyout_) {
      margin = this.workspace_.flyout_.CORNER_RADIUS * 2;
      x = this.workspace_.flyout_.width_ + margin;
    } else {
      margin = 16;
      x = margin;
    }
