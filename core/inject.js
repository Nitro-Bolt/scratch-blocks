...
Blockly.inject = function (container, opt_options) {
  ...
  const workspaceDragSurface = null;

  const workspace = Blockly.createMainWorkspace_(
    svg,
    options,
    blockDragSurface,
...
Blockly.createDom_ = function (container, options) {
  ...
  */
  ...
  const stackGlowFilter = Blockly.utils.createSvgElement(
    "filter",
    {
  ...
  componentTransfer = Blockly.utils.createSvgElement(
    "feComponentTransfer",
    { result: "outBlur" },
    stackGlowFilter
  );
  ...
  const replacementGlowFilter = Blockly.utils.createSvgElement(
    "filter",
    {
  ...
  */
  const disabledPattern = Blockly.utils.createSvgElement(
    "pattern",
    {
...
Blockly.createMainWorkspace_ = function (
  ...
  const mainWorkspace = new Blockly.WorkspaceSvg(
    options,
    blockDragSurface,
    workspaceDragSurface
  );
...
Blockly.init_ = function (mainWorkspace) {
  ...
  const workspaceResizeHandler = Blockly.bindEventWithChecks_(
    window,
    "resize",
    null,
    function () {
