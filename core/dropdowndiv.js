...
Blockly.DropDownDiv.setColour = function (backgroundColour, borderColour) {
  ...
  Blockly.DropDownDiv.DIV_.style.setProperty(
    "--blockly-dropdown-border-colour",
    borderColour
  );
};
...
Blockly.DropDownDiv.show = function (
  ...
  const metrics = Blockly.DropDownDiv.getPositionMetrics(
    primaryX,
    primaryY,
    secondaryX,
    secondaryY
