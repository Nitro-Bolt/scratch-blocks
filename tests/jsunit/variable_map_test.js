...
function test_getVariable_ByNameAndType() {
  ...
  const var_1 = variable_map.createVariable("name1", "type1", "id1");
  const var_2 = variable_map.createVariable("name2", "type1", "id2");
  const var_3 = variable_map.createVariable("name3", "type2", "id3");
  const result_1 = variable_map.getVariable("name1", "type1");
  const result_2 = variable_map.getVariable("name2", "type1");
  const result_3 = variable_map.getVariable("name3", "type2");
...
function test_getVariable_NotFound() {
  variableMapTest_setUp();
  const result = variable_map.getVariable("name1");
  assertNull(result);
  variableMapTest_tearDown();
}
...
function test_getVariableById_Trivial() {
  ...
  const var_2 = variable_map.createVariable("name2", "type1", "id2");
  const var_3 = variable_map.createVariable("name3", "type2", "id3");
  const result_1 = variable_map.getVariableById("id1");
  const result_2 = variable_map.getVariableById("id2");
  const result_3 = variable_map.getVariableById("id3");
...
function test_getVariableById_NotFound() {
  variableMapTest_setUp();
  const result = variable_map.getVariableById("id1");
  assertNull(result);
  variableMapTest_tearDown();
}
...
function test_createVariableAlreadyExists() {
  ...
  let keys = Object.keys(variable_map.variableMap_);
  assertEquals(1, keys.length);
  let varMapLength = variable_map.variableMap_[keys[0]].length;
...
function test_createVariableNameAlreadyExists() {
  ...
  let keys = Object.keys(variable_map.variableMap_);
  assertEquals(1, keys.length);
  const varMapLength = variable_map.variableMap_[keys[0]].length;
  assertEquals(1, varMapLength);
...
function test_getVariablesOfType_Trivial() {
  ...
  const result_array_1 = variable_map.getVariablesOfType("type1");
  const result_array_2 = variable_map.getVariablesOfType("type5");
...
function test_getVariablesOfType_Null() {
  variableMapTest_setUp();
  const var_1 = variable_map.createVariable("name1", "", "id1");
  const var_2 = variable_map.createVariable("name2", "", "id2");
  const var_3 = variable_map.createVariable("name3", "", "id3");
  variable_map.createVariable("name4", "type1", "id4");
  const result_array = variable_map.getVariablesOfType(null);
...
function test_getVariablesOfType_EmptyString() {
  variableMapTest_setUp();
  const var_1 = variable_map.createVariable("name1", null, "id1");
  const var_2 = variable_map.createVariable("name2", null, "id2");
  const result_array = variable_map.getVariablesOfType("");
...
function test_getVariablesOfType_Deleted() {
  variableMapTest_setUp();
  const variable = variable_map.createVariable("name1", null, "id1");
...
function test_getVariablesOfType_DoesNotExist() {
  variableMapTest_setUp();
  const result_array = variable_map.getVariablesOfType("type1");
  isEqualArrays([], result_array);
  variableMapTest_tearDown();
}
...
function test_getVariableTypes_Trivial() {
  ...
  variable_map.createVariable("name3", "type2", "id3");
  variable_map.createVariable("name4", "type3", "id4");
  const result_array = variable_map.getVariableTypes();
...
function test_getAllVariables_Trivial() {
  ...
  const var_2 = variable_map.createVariable("name2", "type1", "id2");
  const var_3 = variable_map.createVariable("name3", "type2", "id3");
  const result_array = variable_map.getAllVariables();
  isEqualArrays([var_1, var_2, var_3], result_array);
  variableMapTest_tearDown();
}
